    ...
    ACPI_RSCONVERT_INFO     *Info)
{
    ...
    while (Count)
    {
        ...
        case ACPI_RSC_INITGET:
             ...
             */
            Mmemset (Resource, 0, INIT_RESOURCE_LENGTH (Info));
        ...
        case ACPI_RSC_SET8:
            ...
            Mmemset (Destination, Info->AmlOffset, Info->Value);
            break;

        case ACPI_RSC_DATA8:

            Target = ACPI_ADD_PTR (char, Resource, Info->Value);
            Mmemcpy (Destination, Source,  ACPI_GET16 (Target));
            break;
    ...
    ACPI_RSCONVERT_INFO     *Info)
{
    ...
    while (Count)
    {
        ...
        case ACPI_RSC_INITSET:
            ...
            Mmemset (Aml, 0, INIT_RESOURCE_LENGTH (Info));
