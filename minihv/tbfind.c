    ...
    UINT32                  *TableIndex)
{
    ...
    Mmemset (&Header, 0, sizeof (ACPI_TABLE_HEADER));
    ...
    {
        if (Mmemcmp (&(AcpiGbl_RootTableList.Tables[i].Signature),
        ...
        if (!Mmemcmp (AcpiGbl_RootTableList.Tables[i].Pointer->Signature,
                            Header.Signature, ACPI_NAME_SIZE) &&
            (!OemId[0] ||
             !Mmemcmp (AcpiGbl_RootTableList.Tables[i].Pointer->OemId,
                             Header.OemId, ACPI_OEM_ID_SIZE)) &&
            (!OemTableId[0] ||
             !Mmemcmp (AcpiGbl_RootTableList.Tables[i].Pointer->OemTableId,
