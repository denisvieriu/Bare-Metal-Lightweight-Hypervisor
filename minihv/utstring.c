...
/*******************************************************************************
 *
 * FUNCTION:    AcpiUtSafeMstrcpy, AcpiUtSafeMstrcat, AcpiUtSafeStrncat
 *
    ...
    char                    *Source)
{
    ...
    if ((Mstrlen (Dest) + Mstrlen (Source)) >= DestSize)
    {
        return (TRUE);
    }
    ...
    ACPI_SIZE               MaxTransferLength)
{
    ...
    ActualTransferLength = ACPI_MIN (MaxTransferLength, Mstrlen (Source));

    if ((Mstrlen (Dest) + ActualTransferLength) >= DestSize)
    {
        return (TRUE);
    }
