    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    {
        Mstrcpy (Hid->String, ObjDesc->String.Pointer);
    }
    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    Mstrcpy (Sub->String, ObjDesc->String.Pointer);
    Sub->Length = Length;
    *ReturnId = Sub;
    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    {
        Mstrcpy (Uid->String, ObjDesc->String.Pointer);
    }
    ...
    ACPI_PNP_DEVICE_ID_LIST **ReturnCidList)
{
    ...
    for (i = 0; i < Count; i++)
    {
        ...
        else /* ACPI_TYPE_STRING */
        {
            ...
            Mstrcpy (NextIdString, CidObjects[i]->String.Pointer);
