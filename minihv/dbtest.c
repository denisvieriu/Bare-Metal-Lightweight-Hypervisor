    ...
    UINT32                  BitLength)
{
     ...
     * unused bits.
     */
    Mmemset (Buffer, BUFFER_FILL_VALUE, ByteLength);
    ...
    if (Mmemcmp (Temp2->Buffer.Pointer, Buffer, ByteLength))
    {
    ...
    if (Mmemcmp (Temp1->Buffer.Pointer, Temp3->Buffer.Pointer, ByteLength))
    {
    ...
    UINT32                  ByteLength)
{
    ...
    WriteValue.String.Length = Mstrlen (ValueToWrite);
    ...
    if (Mstrcmp (Temp2->String.Pointer, ValueToWrite))
    {
    ...
    WriteValue.String.Length = Mstrlen (Temp1->String.Pointer);
    ...
    if (Mstrcmp (Temp1->String.Pointer, Temp3->String.Pointer))
    {
    ...
    ACPI_OBJECT             *Value)
{
    ...
    Mmemcpy (&Params[1], Value, sizeof (ACPI_OBJECT));
    ...
    if (ObjInfo->Type == ACPI_TYPE_METHOD)
    {
        ...
        for (i = 0; i < ArgCount; i++)
        {
            ...
            case ACPI_TYPE_STRING:
                ...
                ThisParam->String.Length = Mstrlen (ThisParam->String.Pointer);
                break;
