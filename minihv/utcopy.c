    ...
    ACPI_SIZE               *BufferSpaceUsed)
{
    ...
    *BufferSpaceUsed = 0;
    ...
    Mmemset (ExternalObject, 0, sizeof (ACPI_OBJECT));
    ...
    ACPI_OPERAND_OBJECT     **RetInternalObject)
{
    ...
    case ACPI_TYPE_STRING:
        ...
        Mmemcpy (InternalObject->String.Pointer,
    ...
    case ACPI_TYPE_BUFFER:
        ...
        Mmemcpy (InternalObject->Buffer.Pointer,
    ...
    ACPI_OPERAND_OBJECT     *DestDesc)
{
    ...
    Mmemcpy (ACPI_CAST_PTR (char, DestDesc),
    ...
    case ACPI_TYPE_BUFFER:
            ...
            (SourceDesc->Buffer.Length))
        {
            ...
            Mmemcpy (DestDesc->Buffer.Pointer,
    ...
    case ACPI_TYPE_STRING:
        ...
        if (SourceDesc->String.Pointer)
        {
            ...
            Mmemcpy (DestDesc->String.Pointer, SourceDesc->String.Pointer,
