 ...
 *              via the ACPI_MOVE_* macros. (This is why a Mmemcpy is not used)
 *
 ******************************************************************************/
    ...
    UINT8                   MoveType)
{
    ...
    for (i = 0; i < ItemCount; i++)
    {
        ...
        case ACPI_RSC_MOVE_SERIAL_RES:
            ...
            Mmemcpy (Destination, Source, ItemCount);
            return;
    ...
    ACPI_RESOURCE_SOURCE    *ResourceSource)
{
    ...
    if (ResourceSource->StringLength)
    {
        ...
        Mstrcpy (ACPI_CAST_PTR (char, &AmlResourceSource[1]),
