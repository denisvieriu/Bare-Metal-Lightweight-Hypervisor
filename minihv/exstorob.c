    ...
    ACPI_OPERAND_OBJECT     *TargetDesc)
{
    ...
    if (Length <= TargetDesc->Buffer.Length)
    {
        ...
        Mmemset (TargetDesc->Buffer.Pointer, 0, TargetDesc->Buffer.Length);
        Mmemcpy (TargetDesc->Buffer.Pointer, Buffer, Length);
    ...
    else
    {
        ...
        Mmemcpy (TargetDesc->Buffer.Pointer, Buffer,
    ...
    ACPI_OPERAND_OBJECT     *TargetDesc)
{
       ...
       (!(TargetDesc->Common.Flags & AOPOBJ_STATIC_POINTER)))
    {
         ...
         */
        Mmemset (TargetDesc->String.Pointer, 0,
            (ACPI_SIZE) TargetDesc->String.Length + 1);
        Mmemcpy (TargetDesc->String.Pointer, Buffer, Length);
    }
    else
    {
        /*
