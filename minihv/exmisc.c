    ...
    ACPI_WALK_STATE         *WalkState)
{
    ...
    Mmemcpy (NewBuf, Operand0->Buffer.Pointer, Length0);
    Mmemcpy (NewBuf + Length0, Operand1->Buffer.Pointer, Length1);
    ...
    ACPI_WALK_STATE         *WalkState)
{
    ...
    case ACPI_TYPE_INTEGER:
        ...
        Mmemcpy (NewBuf, &Operand0->Integer.Value,
                        AcpiGbl_IntegerByteWidth);

        /* Copy the second integer (LSB first) after the first */

        Mmemcpy (NewBuf + AcpiGbl_IntegerByteWidth,
    ...
    case ACPI_TYPE_STRING:
        ...
        Mstrcpy (NewBuf, Operand0->String.Pointer);
        Mstrcpy (NewBuf + Operand0->String.Length,
    ...
    case ACPI_TYPE_BUFFER:
        ...
        Mmemcpy (NewBuf, Operand0->Buffer.Pointer,
                        Operand0->Buffer.Length);
        Mmemcpy (NewBuf + Operand0->Buffer.Length,
    ...
    BOOLEAN                 *LogicalResult)
{
    ...
    else
    {
         ...
         *          Mmemcmp to handle nulls in buffers.
         */
        ...
        Compare = Mmemcmp (Operand0->Buffer.Pointer,
                    LocalOperand1->Buffer.Pointer,
