    ...
    ACPI_RESOURCE_ADDRESS64     *Out)
{
    ...
    case ACPI_RESOURCE_TYPE_ADDRESS64:
        ...
        Mmemcpy (Out, &Resource->Data, sizeof (ACPI_RESOURCE_ADDRESS64));
        break;
    ...
    void                    *Context)
{
    ...
    if ((Vendor->ByteLength < (ACPI_UUID_LENGTH + 1)) ||
        ...
        (Mmemcmp (Vendor->Uuid, Info->Uuid->Data, ACPI_UUID_LENGTH)))
    {
        return (AE_OK);
    }
    ...
    Mmemcpy (Buffer->Pointer, Resource, Resource->Length);
